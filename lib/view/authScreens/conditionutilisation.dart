...
class ConditionUtilsationScreen extends StatefulWidget {
  const ConditionUtilsationScreen({super.key});

  @override
  State<ConditionUtilsationScreen> createState() =>
      _ConditionUtilsationScreenState();
}

class _ConditionUtilsationScreenState extends State<ConditionUtilsationScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text3(text: 'Condition générales d\'utilisation'),
